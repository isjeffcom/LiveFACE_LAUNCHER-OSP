...
public class Workspace extends SmoothPagedView
    ...
    // Change FLING_THRESHOLD_VELOCITY = 500 TO 900 2014-4-5
    // Change ADJACENT_SCREEN_DROP_DURATION = 300 TO 200 2014-4-5
    // Change FLING_THRESHOLD_VELOCITY = 900 TO 300
    private static final float WORKSPACE_OVERSCROLL_ROTATION = 2f;

    private static final int CHILDREN_OUTLINE_FADE_OUT_DELAY = 10;
    private static final int CHILDREN_OUTLINE_FADE_OUT_DURATION = 30;
    private static final int CHILDREN_OUTLINE_FADE_IN_DURATION = 30;

    private static final int BACKGROUND_FADE_OUT_DURATION = 30;
    private static final int ADJACENT_SCREEN_DROP_DURATION = 30;
    private static final int FLING_THRESHOLD_VELOCITY = 20;
    ...
    private static final long CUSTOM_CONTENT_GESTURE_DELAY = 10;
    ...
    private static final int REORDER_TIMEOUT = 135;
    ...
    public Workspace(Context context, AttributeSet attrs, int defStyle) {
		...
		mOriginalDefaultPage = mDefaultPage = sp.getInt("default_screen", a.getInt(R.styleable.Workspace_defaultScreen, 1));
	...
	public void setDefaultScreen() {
		int s = getCurrentPage();
		mDefaultPage = s;
		sp.edit().putInt("default_screen", s).commit();
	}
